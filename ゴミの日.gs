/*
# 更新履歴:コミットログ
## [2020/07/27][ver1.0.0] snippetsから移行
...
var notify_trash = function ( day )
{
  ...
  var date = Snippets.Module.date().add( day, 'days' ).lang( "en" ).format( "dddd" ).toLowerCase();  // dayの曜日(英語)を取得
  var content = Snippets.microCMS().value( APIID, date );
